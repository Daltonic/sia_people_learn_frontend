...
const Page: NextPage = () => {
  return (
    <Layout>
      ...
      <div className="md:w-4/5 px-5 md:px-0 my-16 space-y-6">
        <div>
          <h1 className="text-[#321463] font-medium text-lg mb-2"> Your content in our services</h1>
        ...
        <div>
          <h1 className="text-[#321463] font-medium text-lg mb-2"> Pay Attention</h1>
          <p className="text-[#4F547B]">
        ...
        <div>
          <h1 className="text-[#321463] font-medium text-lg mb-2"> Using our services</h1>
          <p className="text-[#4F547B]">
