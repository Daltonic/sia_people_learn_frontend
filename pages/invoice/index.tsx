  ...
  return (
    <div className="bg-[#F9F9F9] px-5 md:px-20 py-16">
      ...
      <div className="flex justify-end mb-12 md:w-5/6">
        <Button variant="pink" style={{ display: "flex", gap: "6px", alignItems: "center", padding: "8px 30px" }}>
          <SlPrinter />
          Print
        </Button>
      </div>
        <div className="md:w-5/6 bg-white py-10 md:py-16 px-5 md:px-10 rounded-lg space-y-10">
          ...
          <div className="md:flex justify-between items-center gap-2 space-y-10 md:space-y-0">
            <div>
              <div>
                ...
                <p className="text-[#321463] text-lg md:text-mb font-medium">03/10/2021</p>
              </div>
              <div className="md:space-y-2 mt-2 md:mt-10">
                <h1 className="text-[#321463] text-xl md:text-lg font-medium">Supplier</h1>
                <p className="text-[#321463] text-lg md:text-md font-medium">Jobio LLC</p>
            ...
            <div>
              ...
              <div className="md:space-y-2  mt-2 md:mt-10">
                <h1 className="text-[#321463] text-xl md:text-lg font-medium">Customer</h1>
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white">
              <thead className=" bg-[#F5F7FE] text-[#C5165D] font-medium h-20 overflow-hidden rounded-xl md:w-5/6">
                <tr className="">
                  ...
                  <th className=""> VAT (20%)</th>
                  <th className="">Total</th>
                </tr>
              </thead>
              <tbody className=" ">
                <tr className="border-b border-[#F5F7FE]">
                  <td className="w-10 md:text-center p-2 md:p-4">Standard Plan</td>
                  <td className="w-10 md:text-center p-2 md:p-4">$443.00 </td>
                  <td className="w-10 md:text-center p-2 md:p-4">$921.80 </td>
            ...
            <div className="flex items-center justify-between mt-8">
              <h1 className="text-[#321463] text-lg font-medium">
                Total Due
              </h1>
              <p className="text-[#321463] text-lg font-medium">$9,750</p>
            </div>
