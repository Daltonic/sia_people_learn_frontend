...
const LearningJourneyItem: React.FC<LearningJourneyItemProps> = ({ item }) => {
 return (
   <div key={item.id} >
     <div className="bg-white md:shadow-lg md:border border-slate-200 shadow-slate-200 w-full md:w-64 md:h-64 flex flex-col items-center text-center px-8 py-10 rounded-md">
       <div>
         <Image
           width={60}
           height={60}
