...
const Academy: React.FC<ComponentProps> = ({ data, index }) => {
  ...
  return (
    <div className="w-full sm:w-[47%] md:w-[48%] h-fit sm:h-[21rem] md:h-44 bg-white rounded-lg border-[#EDEDED] border p-2 shadow-[#EDEDED] shadow-md md:flex items-center gap-4">
